...
public class GlobalExceptionHandler {
    ...
    public ModelAndView articleHandler(ArticleNotFoundException notFound) {
        ModelAndView modelAndView = new ModelAndView("theme/" + GlobalData.activeTheme + "/error/404");
    ...
    public ModelAndView exceptionHandler(HttpServletRequest request, Exception e) {
        ModelAndView modelAndView = new ModelAndView("theme/" + GlobalData.activeTheme + "/error/500");
        e.printStackTrace();
